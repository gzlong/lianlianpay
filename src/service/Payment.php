...
class Payment
{
    ...
    public function pay($pay_request, $private_key = '', $public_key = '') {
        ...
        $data      = $this->sign_tools->object_to_array($pay_request);
        $signature = $this->sign_tools->sign($data, $private_key);
        $header    = array(
            'sign-type: ' . 'RSA',
...
//        file_put_contents('log.txt', "signature=$signature\n", FILE_APPEND);
        ...
        $result = $this->http_client->post($pay_url, $header, $pay_request);
